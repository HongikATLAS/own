...
images = glob.glob('C:/Users/kchw3_r2l9a77/OneDrive/Desktop/chess.jpg')
for fname in images:
    ...
    print(ret, mtx, dist, rvecs, tvecs) # mtx는 카메라 내부 행렬, dist는 렌즈 왜곡 계수, rvces는 회전 벡터, tvecs는 이동 벡터
    cv2.waitKey(0)
