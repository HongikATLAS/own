...
def average_slope_intercept(image, line_a, left_before, right_before, lines_before):
    ...
    left_fit_average = np.round(left_fit_average)
    right_fit_average = np.round(right_fit_average)
...
FRAME_HEIGTH = 480
# cv2.CAP_DSHOW+0
cap = cv2.VideoCapture('C:/Users/kchw3_r2l9a77/OneDrive/Desktop/test.mp4') #'C:/Users/kchw3_r2l9a77/Downloads/lane.mp4' #'C:/Users/kchw3_r2l9a77/OneDrive/Desktop/test.mp4'
cap.set(cv2.CAP_PROP_FRAME_WIDTH, FRAME_WIDTH)
polygons = np.array([[(0, 300), (0, 480), (640, 480), (640, 300)]])    #(50, 10), (20, 400), (620, 400), (500, 10)
...
while True:
    ...
    lines = cv2.HoughLinesP(cropped_image, 2, np.pi / 180, 50, np.array([]), maxLineGap=7) # #minLineLength=5
    ...
    msg_1 = msg + ',' + msg1 + ','+ msg2
    print(msg_1, msg_1.__class__)
    sock.send(msg_1.encode("utf-8"))
