...
def send_message(notraffic): #  cross_x, cross_y, degre
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str,
                        default='C:/Users/kchw3_r2l9a77/OneDrive/Desktop/지능로봇융합설계프로젝트/yolov5-master/F0929.pt',
                        help='model path or triton URL')
    parser.add_argument('--source', type=str, default='C:/Users/kchw3_r2l9a77/OneDrive/Desktop/지능로봇융합설계프로젝트/yolov5-master/stream.txt', help='file/dir/URL/glob/screen/0(webcam)')
