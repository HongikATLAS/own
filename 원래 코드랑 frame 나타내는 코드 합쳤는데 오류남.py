...
def average_slope_intercept(image, line_a, left_before, right_before, lines_before):
    ...
    return np.array([left_line, right_line]), left_save, right_save, cross_point_x, lines_before
...
while True:
    ...
    averaged_lines, left_saved, right_saved, cross_x, lines_saved = average_slope_intercept(frame, lines, left_saved, right_saved, lines_saved)
